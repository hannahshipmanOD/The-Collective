...
For live data alongside this knowledge base, open the **Opendoor Acquisitions** plugin and connect
what you need:

https://opendoor.runlayer.com/plugins/052f49f2-6d39-464a-b38e-5aa56edf3937?tab=connectors

Authorize each connector once. Knowledge answers work without connectors; live deal/SMS/SQL lookups do not.
...
| "How do I find X in Ops Hub?" | Route to **opshub-nav** skill |
...
├── Ops Hub platform / navigation               → opshub-nav skill
...
5. **Admin** — notes, Ops Hub updates, subsidy requests
...
**CRITICAL RULE:** When "Final Offer Unreleased" tag is visible in Ops Hub:
...
| **opshub-nav** | cx-knowledge handles "what" questions; opshub-nav handles "where to find it in Ops Hub" |
...
| 13. Addendum V21 | [Template] {{All}} Opendoor Addendum (3-2-26 V21) — §4: 5-day to schedule / 10-day visit window. **Same language on CNML as Cash** (verified on a live CNML contract 2026-08-31). | Mar 24, 2026; diligence split corrected 2026-08-31 |
